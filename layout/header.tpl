        ...
        <div class="[{if $blFullwidth}]container[{else}]container-fluid[{/if}]">
            ...
            <div class="header-box">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-md-pull-3 search-col search-box">
                        [{if $oxcmp_user}]
                            [{include file="widget/header/search.tpl"}]
                        [{else}]
                            [{oxcontent ident="loginhinweis"}]
                        [{/if}]
                    </div>

                </div>
                [{include file="widget/header/prosenio_servicemenue.tpl"}]
            </div>
        </div>
