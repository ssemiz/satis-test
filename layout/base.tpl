...
[{capture append="oxidBlock_pageHead"}]
    [{strip}]
        ...
        [{block name="base_style"}]
            ...
            [{oxstyle include="css/icon-font.css"}]
            [{oxstyle include="css/findologic.css"}]
            [{oxstyle include="css/libs/jquery.flexslider.min.css"}]
            [{oxstyle include="css/libs/jquery.fancybox.css"}]
            [{oxstyle include="css/libs/jquery.fancybox-thumbs.css"}]
        [{/block}]
    ...
    <div class="[{if $blFullwidth}]fullwidth-container[{else}]container[{/if}]">
        ...
        <script type="text/javascript">
            (function() {
                ...
                {
                    fl_id = '5273ED78304474ECB393042852E6C65A';
                }else{
                    fl_id = 'F124AAE6EF1AA8E904EB1318E1D8DB12';
                }
                var mainUrl = "https://cdn.findologic.com/static/" + fl_id + "/main.js";
